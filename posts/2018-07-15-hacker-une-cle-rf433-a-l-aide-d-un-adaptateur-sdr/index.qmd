...
## Quelques outils de visualisation avec SDR

### CubicSDR

[cubicsdr.com](https://cubicsdr.com/){rel="nofollow"}

[CubicSDR — Read the Docs](https://cubicsdr.readthedocs.io/en/latest/introduction.html)

[CubicSDR — dernier build avec DMG (0.2.5)](https://github.com/cjcliffe/CubicSDR/releases/tag/0.2.5)
...
| Outil                                                | Type                        | UI            | OS supporté           | Lien                                                                                                       |
| ---------------------------------------------------- | --------------------------- | ------------- | --------------------- | ---------------------------------------------------------------------------------------------------------- |
| NooElec — Supported-SDR-Software                     | Liste de logiciels SDR      | —             | Linux, macOS, Windows | <https://support.nooelec.com/hc/en-us/articles/360005243074-Supported-SDR-Software?utm_source=chatgpt.com> |
| MathWorks — RTL-SDR Support (Communications Toolbox) | Support matériel MATLAB     | CLI/GUI       | Linux, macOS, Windows | <https://www.mathworks.com/hardware-support/rtl-sdr.html>                                                  |
| SDR Touch — Radio en direct                          | Application mobile SDR      | GUI (Android) | Android               | <https://play.google.com/store/apps/details?id=marto.androsdr2>                                            |
| Aerial TV — DVB-T receiver                           | Application mobile TV/DVB-T | GUI (Android) | Android               | <https://play.google.com/store/apps/details?id=info.martinmarinov.aerialtv>                                |

## Quelques outils de décodage LoRa avec SDR

> N.B. Le même adaptateur SDR peut servir à décoder des trames **LoRa** (modulation CSS), en plus des signaux OOK/ASK/FSK traités par `rtl_433`. Les deux mondes sont disjoints : `rtl_433` ne touche pas au LoRa CSS, et les outils LoRa ne décodent ni OOK ni ASK/FSK. On bascule d'un outil à l'autre sur le même dongle, mais pas simultanément.

| Outil                             | Type                         | UI  | OS supporté           | Lien                                       |
| --------------------------------- | ---------------------------- | --- | --------------------- | ------------------------------------------ |
| gr-lora_sdr (EPFL / TU Eindhoven) | GNU Radio 3.10, temps réel   | GUI | Linux, macOS, Windows | <https://github.com/tapparelj/gr-lora_sdr> |
| gr-lora (rpp0)                    | GNU Radio, temps réel        | GUI | Linux, macOS          | <https://github.com/rpp0/gr-lora>          |
| LoRaPHY                           | MATLAB                       | CLI | Linux, macOS, Windows | <https://github.com/jkadbear/LoRaPHY>      |
| lora-phy (pyLoRaPHY)              | Python ≥ 3.8, hors-ligne     | CLI | Linux, macOS, Windows | <https://github.com/myzhang1029/pyLoRaPHY> |
| lora-receiver                     | Python, streaming/hors-ligne | CLI | Linux, macOS, Windows | <https://pypi.org/project/lora-receiver/>  |
| LoRa Craft (PentHertz)            | Python + GNU Radio           | CLI | Linux (prioritaire)   | <https://github.com/PentHertz/LoRa_Craft>  |
| python-loranode                   | Python, avec gr-lora         | CLI | Linux                 | <https://github.com/rpp0/python-loranode>  |

## Quelques outils de décodage de capteurs RF (OOK/ASK/FSK) avec SDR

| Outil    | Type                                                               | UI  | OS supporté           | Lien                                  |
| -------- | ------------------------------------------------------------------ | --- | --------------------- | ------------------------------------- |
| rtl_433  | Décodage capteurs radio (TPMS, Wireless-MBus, météo…), OOK/ASK/FSK | CLI | Linux, macOS, Windows | <https://github.com/merbanan/rtl_433> |
| URH      | Analyse/émission de signaux radio, capture et spoofing             | GUI | Linux, macOS, Windows | <https://github.com/jopohl/urh>       |
| GQRX     | Spectre/audio SDR                                                  | GUI | Linux, macOS, Windows | <http://gqrx.dk/>                     |
| CubicSDR | Spectre/audio SDR                                                  | GUI | Linux, macOS, Windows | <https://cubicsdr.com/>               |
| SDRangel | Analyse spectre/multi-protocoles                                   | GUI | Linux, macOS, Windows | <https://www.sdrangel.org/>           |
| SDR++    | Spectre/audio SDR                                                  | GUI | Linux, macOS, Windows | <https://www.sdrpp.org/>              |
...
rtl_433 -f 868.3M
rtl_433 -f 868.3M -Y classic
# -Y classic — Mode de décodage classique (ancien comportement avant la v25.12). Par défaut depuis la v25.12, rtl_433 utilise un mode "flex" avec un sample rate plus bas (250k). Le flag -Y classic restaure les anciens décodeurs avec un sample rate de 1M, qui est plus fiable pour certains protocoles spécifiques à 868 MHz.
```
